  ...
  return (
    ...
    <hr className="fade-in-hrdelay" />
      <TermsConditionsParagraph className="fade-in-delay">
        ...
        <br></br>
        <br></br>
        This website is operated by QualiTrees. Throughout the site, the terms
        “we”, “us” and “our” refer to QualiTrees. QualiTrees offers this
        ...
        <br></br>
        <br></br>
        In no case shall QualiTrees, our directors, officers, employees,
        ...
        <br></br>
        <br></br>
        You agree to indemnify, defend and hold harmless QualiTrees and our
        ...
        laws of 317 N. Palo Cedro Dr., Diamond Bar, CA, 91765, United States.
        <br></br>
        <br></br>
        <br></br>
        ...
        qualitreescollective@gmail.com.
